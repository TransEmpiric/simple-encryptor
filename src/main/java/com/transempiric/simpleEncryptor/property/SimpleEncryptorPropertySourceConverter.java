 ...
 * @author SlowBurner
 */
public class SimpleEncryptorPropertySourceConverter {
    ...
    public static <T> PropertySource<T> makeEncryptable(SimpleEncryptorInterceptionMode interceptionMode, SimpleEncryptorPropertyResolver propertyResolver, PropertySource<T> propertySource) {
        ...
        // System.out.println("Converting PropertySource {} [{}] to {}", propertySource.getName(), propertySource.getClass().getName(), AopUtils.isAopProxy(encryptablePropertySource) ? "AOP Proxy" : encryptablePropertySource.getClass().getSimpleName());
